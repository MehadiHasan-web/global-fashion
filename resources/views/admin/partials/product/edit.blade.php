            ...
            <div class="card-body">
                <form action="{{ route('product.update', $product->id) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="col-8 border rounded  ">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="editor" rows="3"
                                class="form-control @error('description') is-invalide @enderror " placeholder="Write description">{{ old('description', $product->description ?? '') }}</textarea>
                            @error('description')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="d-flex">
                            <div class="form-group col-6 p-0 pr-1">
                                ...
                                <input type="number" name="price" id=""
                                    ...
                                    placeholder="Write product price" value="{{ old('price', $product->price ?? '') }}">
                                @error('price')
                                    <p class="text-danger">{{ $message }}</p>
                                @enderror
                            </div>
                            <div class="form-group col-6 p-0 pl-1">
                                ...
                                <input type="number" name="discounted_price" id=""
                                    ...
                                    placeholder="Write product discounted price"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="brand_name" id=""
                                ...
                                placeholder="Write brand name" value="{{ old('brand_name', $product->brand_name) }}">
                            @error('brand_name')
                                <p class="text-danger">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="d-flex mb-2">
                            <div class="form-check">
                                <input class="form-check-input  @error('gender') is-invalide @enderror" type="radio"
                                    ...
                                    {{ $product->gender == 1 ? 'checked' : '' }} style="margin-top: 9px">
                                    ...
                                    @foreach ($tags as $item)
                                        <div class="form-check mr-2 ml-2 ">
                                            <input name="tag_id[]" class="form-check-input" type="checkbox"
                                                ...
                                                {{ in_array($item->id, old('tag_id', $selected_tag)) ? 'checked' : '' }}
                    ...
                    <div class="col-4 ">
                        ...
                        <div class="file-upload border rounded">
                            ...
                            <div class="image-upload-wrap">
                                <input name="thumb_image"
                                    ...
                                    onchange="readURL(this);" accept="image/*" value="hi" />
                                <div class="drag-text">
                                    <h3>Drag and drop </h3>
                                </div>
                            </div>
                        ...
                        {{-- priviue image  --}}
                        <div class="mt-3 border border-success rounded p-1">
                            <img src="{{ URL::to('storage/product_thumbnail/' . $product->thumb_image) }}" alt=""
                                class="img-fluid  rounded">
                            <span class="text-muted " style="font-size: 10px">Thumbnail Image</span>
                            <hr>
                            ...
                            <div class="mt-3">
                                ...
                                @isset($product->images)
                                    @foreach (json_decode($product->images) as $item)
                                        <img src="{{ URL::to('storage/product_image/' . $item) }}" alt=""
                                            class="img-fluid rounded" style="width: 90px; height:100px; margin-bottom: 5px;">
                                    @endforeach
                                    <br>
