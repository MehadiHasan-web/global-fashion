        ...
        <div class="row">
                ...
                <div class="product-wrap mb-25">
                    <div class="product-img">
                        <a href="product-details.html">
                            <img class="default-img" src="{{ asset('frontend/img/product/pro-8.jpg') }}" alt="">
                            <img class="hover-img" src="{{ asset('frontend/img/product/pro-6.jpg') }}" alt="">
                        </a>
            ...
            <div class="col-xl-3 col-md-6 col-lg-4 col-sm-6">
                <div class="product-wrap mb-25">
                    <div class="product-img">
                        <a href="product-details.html">
                            <img class="default-img" src="{{ asset('frontend/img/product/pro-7.jpg') }}" alt="">
                            <img class="hover-img" src="{{ asset('frontend/img/product/pro-4-1.jpg') }}" alt="">
                        </a>
                        ...
                        <div class="product-action">
                            ...
                            <div class="pro-same-action pro-cart">
                                <a title="Add To Cart" href="#"><i class="fa-solid fa-cart-shopping"></i> Add to
                                    cart</a>
                            </div>
                            <div class="pro-same-action pro-quickview">
                                <a title="Quick View" href="#" data-bs-toggle="modal"
            ...
            <div class="col-xl-3 col-md-6 col-lg-4 col-sm-6">
                <div class="product-wrap mb-25">
                    <div class="product-img">
                        <a href="product-details.html">
                            <img class="default-img" src="{{ asset('frontend/img/product/pro-6.jpg') }}" alt="">
                            <img class="hover-img" src="{{ asset('frontend/img/product/pro-6-1.jpg') }}" alt="">
                        </a>
                        <span class="pink">-10%</span>
                        <div class="product-action">
                            <div class="pro-same-action pro-wishlist">
                ...
                <div class="product-wrap mb-25">
                    <div class="product-img">
                        ...
                        <div class="product-action">
                            ...
                            <div class="pro-same-action pro-cart">
                                <a title="Add To Cart" href="#"><i class="fa-solid fa-cart-shopping"></i> Add
                                    to cart</a>
                            </div>
                            <div class="pro-same-action pro-quickview">
                                <a title="Quick View" href="#" data-bs-toggle="modal"
                    ...
                    <div class="col-xl-3 col-md-6 col-lg-4 col-sm-6">
                        <div class="product-wrap mb-25">
                            ...
                            <div class="product-content text-center">
                                ...
                                <div class="product-price">
                                    <span><strong>ট</strong> {{ $item->discounted_price ?? '' }}.00</span>
                                    <span class="old"><strong>ট</strong> {{ $item->price ?? '' }}.00</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-xl-3 col-md-6 col-lg-4 col-sm-6">
                <div class="product-wrap mb-25">
                    <div class="product-img">
                        <a href="product-details.html">
                            <img class="default-img" src="{{ asset('frontend/img/product/pro-6.jpg') }}"
                                alt="">
                            <img class="hover-img" src="{{ asset('frontend/img/product/pro-6-1.jpg') }}"
                                alt="">
                        </a>
                        <span class="pink">-10%</span>
                        <div class="product-action">
            ...
            <div class="col-xl-3 col-md-6 col-lg-4 col-sm-6">
                <div class="product-wrap mb-25">
                    <div class="product-img">
                        <a href="product-details.html">
                            <img class="default-img" src="{{ asset('frontend/img/product/pro-8.jpg') }}"
                                alt="">
                            <img class="hover-img" src="{{ asset('frontend/img/product/pro-6.jpg') }}"
                                alt="">
                        </a>
                        <span class="pink">-10%</span>
                        <div class="product-action">
            ...
            <div class="col-xl-3 col-md-6 col-lg-4 col-sm-6">
                <div class="product-wrap mb-25">
                    <div class="product-img">
                        <a href="product-details.html">
                            <img class="default-img" src="{{ asset('frontend/img/product/pro-7.jpg') }}"
                                alt="">
                            <img class="hover-img" src="{{ asset('frontend/img/product/pro-4-1.jpg') }}"
                                alt="">
                        </a>
